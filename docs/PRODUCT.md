...
Up to three routes is a ceiling, not a quota. Local routes use major roads and junctions as limits, across administrative boundaries. A loop must close. Best fit searches candidate loop sizes, completes 100–103% of the total target and ranks mapped-road score before lap count. Manual lap plans retain a ±3% tolerance. All returned geometry stays in coverage. Exported GPX always matches the stored selected path. Personal road exclusions persist in the browser and require replanning.
